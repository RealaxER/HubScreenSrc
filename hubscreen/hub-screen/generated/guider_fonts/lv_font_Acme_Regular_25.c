 ...
 * Size: 25 px
 * Bpp: 4
 * Opts: --user-data-dir=C:\Users\bdhien\AppData\Roaming\gui-guider --app-path=D:\gui_guider\Gui-Guider\resources\app.asar --no-sandbox --no-zygote --lang=en-US --device-scale-factor=1.25 --num-raster-threads=4 --enable-main-frame-before-activation --renderer-client-id=5 --time-ticks-at-unix-epoch=-1717052398799296 --launch-time-ticks=347860883632 --mojo-platform-channel-handle=3044 --field-trial-handle=1736,i,5774509583011111400,1646299910298166778,131072 --disable-features=SpareRendererForSitePerProcess,WinRetrieveSuggestionsOnlyOnDemand /prefetch:1
 ******************************************************************************/
